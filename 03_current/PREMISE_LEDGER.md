...
| K4 | **the a–b angle** | direction of D8's second generator | D8 | **chosen, kind 3** — the D8 frequency ratio sweeps [1.04, 23.9] [corrected 2026-09-26: 23.9 → 22.93, a resolution artifact; exactly 1/sin(θ/2), INPUT_LEDGER §3.2]; plurality forbids only b = ±a | INPUT_LEDGER §2d #4, §3.2 |
