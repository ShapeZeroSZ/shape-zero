...
| INPUT_LEDGER §3.2; C1S/D8_SYNTHESIS §7 | φ attainable near 76° of the a–b angle | **invariant; correctly recorded** as "attainability is not selection". No script in the repository performs the sweep — prose only [2026-09-26: the ratio is exactly 1/sin(θ/2); the recorded 23.9 at 5° is corrected to 22.93, a T = 600 resolution artifact (`shape_zero_tests/d8_angle_readout.py`; INPUT_LEDGER §3.2)] |
