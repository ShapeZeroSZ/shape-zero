...
> **Documents moved.** `C1S_SYNTHESIS.md`, `C1_ERRATA.md`, `REVISION_2_BASE.md`
> and `shape_zero_a2_synthesis.md` now live only in `02_synthesis/`. Earlier
> versions of the archive kept identical copies here; the copies were removed so
> the two could not drift apart. References below to these files mean the
> `02_synthesis/` versions.
